...
<head>
	...
	<link rel="icon" type="image/x-icon" href=""/>
		...
		<meta property="og:site_name" content="http://localhost/shopbanhanglaravel1/"/>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="images/ico/apple-touch-icon-144-precomposed.png">
...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +84 114 933 31</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> hoanganhduczzxx@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					...
					<div class="col-sm-5">
						...
						<div class="search_box pull-right">
							<input type="text" name="keywwords_submit" placeholder="Tìm kiếm sản phẩm"/>
	...
	<script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v16.0" nonce="o9MnAcy9"></script>
</body>
</html>